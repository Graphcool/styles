...
export const red0: string = 'rgba(349,98,60,0)'
export const red50: string = 'rgba(349,98,60,.5)'
...
export const size16: string = '16px'
export const size25: string = '25px'
export const size38: string = '38px'
